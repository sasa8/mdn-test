...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src.930dd1c1.js":[function(require,module,exports) {
var define;
...
parcelRequire = function (e, r, t, n) {
  ...
  "b8ve": [function (require, module, exports) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
      value: !0
    }), exports.useAsync = h, exports.useAsyncFetchMore = exports.useAsyncCallback = exports.useAsyncAbortable = void 0;
    ...
    var r = "undefined" != typeof Symbol ? Symbol.iterator || (Symbol.iterator = Symbol("Symbol.iterator")) : "@@iterator",
        n = "undefined" != typeof Symbol ? Symbol.asyncIterator || (Symbol.asyncIterator = Symbol("Symbol.asyncIterator")) : "@@asyncIterator";
    ...
    var o = "undefined" != typeof window && void 0 !== window.document && void 0 !== window.document.createElement ? e.useLayoutEffect : e.useEffect,
        s = function s(t) {
      var r = (0, e.useRef)(t);
      return o(function () {
        r.current = t;
      ...
      var o = y(u),
        ...
        if (a(t), u instanceof Promise) return f.set(u), i.setLoading(), u.then(function (e) {
          d(u) && i.setResult(e), o.onSuccess(e, {
            isCurrent: function isCurrent() {
              return f.is(u);
            }
          });
        }, function (e) {
          d(u) && i.setError(e), o.onError(e, {
            isCurrent: function isCurrent() {
              return f.is(u);
            }
          });
        ...
        var s = u;
        return i.setResult(s), Promise.resolve(s);
      },
          g = !l();

      return (0, e.useEffect)(function () {
        g ? o.executeOnMount && v.apply(void 0, n) : o.executeOnUpdate && v.apply(void 0, n);
      }, n), t({}, i.value, {
        set: i.set,
        merge: i.merge,
        reset: i.reset,
        execute: v,
        currentPromise: f.get(),
        currentParams: c
      });
    };
    ...
    var S = function S(t, r, n) {
      ...
      return h(function () {
        ...
        try {
          ...
          return o.current = s, Promise.resolve(u(function () {
            return Promise.resolve(t.apply(void 0, [s.signal].concat(r)));
          }, function (e, t) {
            if (o.current === s && (o.current = void 0), e) throw t;
            return t;
          }));
        } catch (c) {
    ...
    exports.useAsyncAbortable = S;

    var x = function x(e, r) {
      return g(e, [], t({}, r, {
        executeOnMount: !1,
        executeOnUpdate: !1
      }));
    ...
    var w = function w(t) {
      var r = t.value,
        ...
        try {
          ...
          if ("loading" === d.status) throw new Error("Can't fetch more, because we are already fetching more!");
          f.current = f.current + 1;
          var t = f.current;
          return Promise.resolve(n(e.result)).then(function (n) {
            var s = e.status === c().status && e.result === c().result,
                a = f.current === t;
            return s && a && (r.merge({
              result: u(r.result, n)
            }), o(n) && l(!0)), n;
      ...
      return (0, e.useEffect)(function () {
        ...
        canFetchMore: "success" === r.status && "loading" !== d.status,
        loading: d.loading,
        status: d.status,
        fetchMore: d.execute,
        isEnd: i
  ...
  "KYJg": [function (require, module, exports) {
    ...
    function r(t) {
      ...
      return t instanceof Date || "object" == _typeof(t) && "[object Date]" === r ? new Date(t.getTime()) : "number" == typeof t || "[object Number]" === r ? new Date(t) : ("string" != typeof t && "[object String]" !== r || "undefined" == typeof console || (console.warn("Starting with v2.0.0-beta.1 date-fns doesn't accept strings as date arguments. Please use `parseISO` to parse strings. See: https://git.io/fjule"), console.warn(new Error().stack)), new Date(NaN));
    }
  }, {
  ...
  "ACz4": [function (require, module, exports) {
    ...
    function o(o, t, n) {
      var s;
      return n = n || {}, s = "string" == typeof e[o] ? e[o] : 1 === t ? e[o].one : e[o].other.replace("{{count}}", t), n.addSuffix ? n.comparison > 0 ? "in " + s : s + " ago" : s;
    }
  }, {}],
  ...
  "ZyeE": [function (require, module, exports) {
    "use strict";
    ...
    function t(t) {
      return function (a) {
        ...
        var s,
            ...
            o = Array.isArray(f) ? r(f, function (t) {
          return t.test(c);
        }) : e(f, function (t) {
          return t.test(c);
        });
        return s = t.valueCallback ? t.valueCallback(o) : o, {
  ...
  "lcWw": [function (require, module, exports) {
    "use strict";
  ...
  "V2hq": [function (require, module, exports) {
    "use strict";

    function e(e, t) {
      for (var r = e < 0 ? "-" : "", o = Math.abs(e).toString(); o.length < t;) {
        o = "0" + o;
      }
  ...
  "I9iY": [function (require, module, exports) {
    "use strict";
  ...
  "IuuM": [function (require, module, exports) {
    "use strict";
  ...
  "wuZP": [function (require, module, exports) {
    "use strict";
  ...
  "TVAh": [function (require, module, exports) {
    "use strict";
  ...
  "PrDZ": [function (require, module, exports) {
    "use strict";
  ...
  "JbHP": [function (require, module, exports) {
    "use strict";
    ...
    function i(n, i) {
      ...
      var s = (0, t.default)(n, i),
          ...
          C = null == l.firstWeekContainsDate ? f : (0, e.default)(l.firstWeekContainsDate);
  ...
  "x8HL": [function (require, module, exports) {
    "use strict";
    ...
    function s(n, s) {
      ...
      var a = s || {},
          ...
          d = null == a.firstWeekContainsDate ? o : (0, e.default)(a.firstWeekContainsDate),
          f = (0, t.default)(n, s),
          C = new Date(0);
  ...
  "Z7oM": [function (require, module, exports) {
    "use strict";
  ...
  "S8Vi": [function (require, module, exports) {
    "use strict";
    ...
    var t = o(require("../lightFormatters/index.js")),
        ...
        a = o(require("../../../_lib/getUTCISOWeekYear/index.js")),
        n = o(require("../../../_lib/getUTCWeek/index.js")),
        i = o(require("../../../_lib/getUTCWeekYear/index.js")),
        _u2 = o(require("../../addLeadingZeros/index.js"));
    ...
    var d = {
      ...
      Y: function Y(t, e, r, a) {
        var n = (0, i.default)(t, a),
            o = n > 0 ? n : 1 - n;

        if ("YY" === e) {
          var d = o % 100;
          return (0, _u2.default)(d, 2);
        }

        return "Yo" === e ? r.ordinalNumber(o, {
          unit: "year"
        }) : (0, _u2.default)(o, e.length);
      },
      R: function R(t, e) {
        var r = (0, a.default)(t);
        return (0, _u2.default)(r, e.length);
      },
      u: function u(t, e) {
      ...
      w: function w(t, e, r, a) {
        var i = (0, n.default)(t, a);
        return "wo" === e ? r.ordinalNumber(i, {
          unit: "week"
        }) : (0, _u2.default)(i, e.length);
      },
      I: function I(t, e, a) {
        var n = (0, r.default)(t);
        return "Io" === e ? a.ordinalNumber(n, {
          unit: "week"
        }) : (0, _u2.default)(n, e.length);
      },
      d: function d(e, r, a) {
        return "do" === r ? a.ordinalNumber(e.getUTCDate(), {
          unit: "date"
        }) : t.default.d(e, r);
      },
      D: function D(t, r, a) {
        var n = (0, e.default)(t);
        return "Do" === r ? a.ordinalNumber(n, {
          unit: "dayOfYear"
        }) : (0, _u2.default)(n, r.length);
      },
      E: function E(t, e, r) {
        var a = t.getUTCDay();
      ...
      c: function c(t, e, r, a) {
        ...
        switch (e) {
          ...
          case "cc":
            return (0, _u2.default)(i, e.length);
      ...
      i: function i(t, e, r) {
        ...
        switch (e) {
          ...
          case "ii":
            return (0, _u2.default)(n, e.length);
      ...
      H: function H(e, r, a) {
        return "Ho" === r ? a.ordinalNumber(e.getUTCHours(), {
          unit: "hour"
        }) : t.default.H(e, r);
      },
      K: function K(t, e, r) {
        ...
        return "Ko" === e ? r.ordinalNumber(a, {
          unit: "hour"
        }) : (0, _u2.default)(a, e.length);
      },
      k: function k(t, e, r) {
        var a = t.getUTCHours();
        return 0 === a && (a = 24), "ko" === e ? r.ordinalNumber(a, {
          unit: "hour"
        }) : (0, _u2.default)(a, e.length);
      },
      m: function m(e, r, a) {
        return "mo" === r ? a.ordinalNumber(e.getUTCMinutes(), {
          unit: "minute"
        }) : t.default.m(e, r);
      },
      s: function s(e, r, a) {
        return "so" === r ? a.ordinalNumber(e.getUTCSeconds(), {
          unit: "second"
        }) : t.default.s(e, r);
      },
      S: function S(e, r) {
      ...
      t: function t(_t4, e, r, a) {
        var n = a._originalDate || _t4,
            i = Math.floor(n.getTime() / 1e3);
        return (0, _u2.default)(i, e.length);
      },
      T: function T(t, e, r, a) {
    ...
    function s(t, e) {
      var r = t > 0 ? "-" : "+",
          ...
          n = Math.floor(a / 60),
          i = a % 60;
      if (0 === i) return r + String(n);
      var o = e || "";
      return r + String(n) + o + (0, _u2.default)(i, 2);
    }

    function f(t, e) {
      return t % 60 == 0 ? (t > 0 ? "-" : "+") + (0, _u2.default)(Math.abs(t) / 60, 2) : l(t, e);
    }
    ...
    function l(t, e) {
      var r = e || "",
          a = t > 0 ? "-" : "+",
          n = Math.abs(t);
      return a + (0, _u2.default)(Math.floor(n / 60), 2) + r + (0, _u2.default)(n % 60, 2);
    }
  ...
  "VJXN": [function (require, module, exports) {
    ...
    Object.defineProperty(exports, "__esModule", {
      value: !0
    }), exports.isProtectedDayOfYearToken = o, exports.isProtectedWeekYearToken = r, exports.throwProtectedError = n;
    var t = ["D", "DD"],
        e = ["YY", "YYYY"];
  ...
  "OZJZ": [function (require, module, exports) {
    ...
    function g(d, w, m) {
      ...
      return g.match(c).map(function (e) {
        var r = e[0];
  ...
  "GvNP": [function (require, module, exports) {
    "use strict";
  ...
  "VmGv": [function (require, module, exports) {
    function e(e) {
      ...
      function g(g, u) {
        ...
        var f = [],
            p = "-" === (g = "" + g).charAt(0);
        return g = g.replace(/^\-/g, ""), e.negativeLeftOut || u.noUnits || f.push(e.prefix), p && f.push(e.negativeLeftSymbol), e.negativeLeftOut && !u.noUnits && f.push(e.prefix), g = g.split("."), null != e.round && o(g, e.round), null != e.truncate && (g[1] = n(g[1], e.truncate)), e.padLeft > 0 && (g[0] = r(g[0], e.padLeft)), e.padRight > 0 && (g[1] = i(g[1], e.padRight)), !u.noSeparator && g[1] && (g[1] = a(g[1], e.decimalsSeparator)), !u.noSeparator && g[0] && (g[0] = t(g[0], e.integerSeparator)), f.push(g[0]), g[1] && (f.push(e.decimal), f.push(g[1])), e.negativeRightOut && !u.noUnits && f.push(e.suffix), p && f.push(e.negativeRightSymbol), e.negativeRightOut || u.noUnits || f.push(e.suffix), f.join("");
      }
      ...
      return "boolean" != typeof e.negativeLeftOut && (e.negativeLeftOut = !1 !== e.negativeOut), "boolean" != typeof e.negativeRightOut && (e.negativeRightOut = !1 !== e.negativeOut), e.prefix = e.prefix || "", e.suffix = e.suffix || "", "string" != typeof e.integerSeparator && (e.integerSeparator = "string" == typeof e.separator ? e.separator : ","), e.decimalsSeparator = "string" == typeof e.decimalsSeparator ? e.decimalsSeparator : "", e.decimal = e.decimal || ".", e.padLeft = e.padLeft || -1, e.padRight = e.padRight || -1, g.negative = e.negative, g.negativeOut = e.negativeOut, g.negativeType = e.negativeType, g.negativeLeftOut = e.negativeLeftOut, g.negativeLeftSymbol = e.negativeLeftSymbol, g.negativeRightOut = e.negativeRightOut, g.negativeRightSymbol = e.negativeRightSymbol, g.prefix = e.prefix, g.suffix = e.suffix, g.separate = e.separate, g.integerSeparator = e.integerSeparator, g.decimalsSeparator = e.decimalsSeparator, g.decimal = e.decimal, g.padLeft = e.padLeft, g.padRight = e.padRight, g.truncate = e.truncate, g.round = e.round, g.unformat = u, g;
    }
  ...
  "or5y": [function (require, module, exports) {
    ...
    var e = a(require("react")),
        t = a(require("format-number")),
        r = a(require("date-fns/format"));
    ...
    function i(a) {
      return a.data.map(function (a, i) {
        return e.default.createElement("p", {
          key: i
        }, "Misses ", a.orbiting_body, " tomorrow at", " ", (0, r.default)(a.epoch_date_close_approach, "h:mmaaaa"), " by", " ", u(parseInt(a.miss_distance.miles, 10)), " miles whilst travelling at ", (0, t.default)({
          truncate: 0
        })(a.relative_velocity.miles_per_hour), "mph");
      });
    }
  }, {
    "react": "n8MK",
  ...
  "maha": [function (require, module, exports) {
    "use strict";
    ...
    function l(r) {
      var l = r.name,
          u = r.is_potentially_hazardous_asteroid,
          d = r.close_approach_data,
          n = r.nasa_jpl_url;
      return e.default.createElement("div", {
        className: u ? "is-hazard" : "no-hazard"
      }, e.default.createElement("h2", null, l.replace(/[()]/g, "")), e.default.createElement("p", null, "Potentially hazardous?", " ", e.default.createElement(a.default, {
        yes: u
  ...
  "leDv": [function (require, module, exports) {
    "use strict";
    ...
    var e = u(require("react")),
        t = require("react-async-hook"),
        r = u(require("date-fns/addDays")),
        n = u(require("date-fns/format")),
        a = u(require("./Orbital"));
    ...
    var i = function i() {
      return fetch("https://api.nasa.gov/neo/rest/v1/feed?start_date=".concat(l(), "&api_key=DEMO_KEY")).then(function (e) {
        return e.json();
      });
    };

    function c() {
      var u = (0, t.useAsync)(i, []);
      if (u.loading) return document.title = "Counting potential earth HAZARDS…", e.default.createElement("p", null, "Getting data from NASA right now to check whether something from space is going to hit us. One moment…");
      var c = l((0, r.default)(new Date(), 1)),
          s = u.result.near_earth_objects[c].reduce(function (e, t) {
        return t.is_potentially_hazardous_asteroid ? e + 1 : e;
      }, 0);
      document.title = "".concat(s, " potential HAZARDS ").concat(s > 0 ? "😱" : "👍");
      var d = u.result.near_earth_objects[c];
      return e.default.createElement("div", null, e.default.createElement("p", null, (0, n.default)((0, r.default)(new Date(), 1), "EEEE d-MMM"), " there will be", " ", e.default.createElement("strong", null, d.length)), e.default.createElement("hr", null), d.sort(function (e) {
        return e.is_potentially_hazardous_asteroid ? -1 : 1;
      }).map(function (t) {
        return e.default.createElement(a.default, o({
          key: t.id
        }, t));
      }));
    }
  ...
  "Focm": [function (require, module, exports) {
    ...
    (0, t.render)(e.default.createElement(r.default, null), document.getElementById("app")), module.hot && module.hot.accept(function () {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src.930dd1c1.js"], null)
//# sourceMappingURL=/src.930dd1c1.7298dc1f.js.map